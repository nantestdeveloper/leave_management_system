...
ActiveRecord::Schema.define(version: 2019_11_14_104904) do
  ...
  create_table "total_leave_availables", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
